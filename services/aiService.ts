...
СТИЛЬ ОБЩЕНИЯ:
- Приветствуй тепло: "Привет! Как дела?", "Здравствуй! Рад видеть!"
...
- Если не знаешь - честно скажи, но предложи помочь найти ответ`
    ...
    const models = [
      ...
      'openchat/openchat-7b:free',              // Бесплатная быстра��
...
ОБЩЕНИЕ:
- Приветствуй: "Привет! Как дела? Чем помочь?"
- На ��опросы типа "Как дела?" отвечай: "Все отлично! А у тебя как?"
